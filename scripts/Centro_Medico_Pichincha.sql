...
-- Archivo: Centro_Medico_Pichincha.sql
...
CHANGE MASTER TO
    MASTER_HOST 	= '10.79.5.216',               -- Dirección IP o nombre del host del servidor maestro
...
CHANGE MASTER TO
    ...
    MASTER_USER 	= 'replicator',                -- Usuario configurado para la replicación en el maestro
    MASTER_PASSWORD = 'qweQWE!@#',          -- Contraseña del usuario de replicación
    MASTER_LOG_FILE = 'mysql-bin.000008',      -- Archivo de registro binario actual en el maestro
    MASTER_LOG_POS 	= 2887;                     -- Posición en el archivo binario del maestro
...
CREATE VIEW ConsultasPichincha AS
SELECT * 
FROM GestionHospitalaria.ConsultasMedicas 
WHERE Ubicacion = 'PICHINCHA';
